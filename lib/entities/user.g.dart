...
const UserSchema = CollectionSchema(
  ...
  links: {
    r'linkToCertifSaldo': LinkSchema(
      id: 1700726090001617758,
      name: r'linkToCertifSaldo',
      target: r'CertifSaldo',
      single: true,
    )
  },
  embeddedSchemas: {},
...
User _userDeserialize(
  ...
  final object = User(
    ...
    role:
        _UserroleValueEnumMap[reader.readByteOrNull(offsets[2])] ?? Role.admin,
...
List<IsarLinkBase<dynamic>> _userGetLinks(User object) {
  return [object.linkToCertifSaldo];
}

void _userAttach(IsarCollection<dynamic> col, Id id, User object) {
  object.id = id;
  object.linkToCertifSaldo.attach(
      col, col.isar.collection<CertifSaldo>(), r'linkToCertifSaldo', id);
}
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> linkToCertifSaldo(
      FilterQuery<CertifSaldo> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'linkToCertifSaldo');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> linkToCertifSaldoIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'linkToCertifSaldo', 0, true, 0, true);
    });
  }
}
